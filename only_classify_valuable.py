...
if __name__ == '__main__':
    ...
    n_warm = 1
    n_sim = 10
    ip_valuable_analysisor = "bimodal-no-ipcp_value-ipcp_value-no-lru-1core"
    ...
    ip_classify_paper = "bimodal-no-ipcp_important-ipcp_important-no-lru-1core"
    #ip_classify_paper_compare = "bimodal-no-paper_ipcp_ip_classify_v1-paper_ipcp-no-lru-1core"

    #build
    branch_predicor = "bimodal"
    l1i_prefetcher = "no"
    l1d_prefetcher = "ipcp_value"
    l2c_prefetcher = "ipcp_value"
    llc_prefetcher = "no"
    llc_replacement = "lru"
    core_num = "1"
    ...
    l1d_prefetcher = "ipcp_important"
    l2c_prefetcher = "ipcp_important"
    compile_prefetcher(branch_predicor, l1i_prefetcher, l1d_prefetcher, l2c_prefetcher, llc_prefetcher, llc_replacement, core_num)
